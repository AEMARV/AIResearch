...
if __name__ == '__main__':
    ...
    l1_list = [0]
    l2_list = l1_list
    numlayers_list = [25,20]
    lr_list = [0.0001, 0.0005]
    init_coef_list = [2,1,3]
    optimizer_list = [SGD]
    loss_list = [Subset_Seg_Balanced]
    model_list = [Panc_Seg_Bottled]
    scale_list = [1]
    ...
    for exp_dict in exp_list:
        exp = Trainings_SimpleCIFAR10('SortedValueExp', description=desc, worker_id=worker_id)
